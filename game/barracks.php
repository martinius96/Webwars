...
<ul class="art-vmenu">
<?php echo $lang['MENU_BARRACKS.PHP'];?>
</ul>
...
<?php 
 ...
 if(isset($_SESSION['uid'])){
         ...
         if($user['fraction'] == 0){
         include("barracks/usa.php");}
         if($user['fraction'] == 1){
         include("barracks/germany.php");}
         if($user['fraction'] == 2){
         include("barracks/slovakia.php");}
         if($user['fraction'] == 3){
         include("barracks/zssr.php");}
         if($user['fraction'] == 4){ 
         include("barracks/italy.php");}
         if($user['fraction'] == 5){
         include("barracks/britain.php");}       
