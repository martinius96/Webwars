...
?>	<center><h2>Prehľad majora: <?php echo $mayor['username']; ?></h2></center>
	<br />
	...
	<table cellpadding="2" cellspacing="4">
		<tr>
			...
			<td>Major:</td>
			<td><i><a <?php if($mayor['b4'] == 1){ ?>style="color: #2196F3;"<?php } ?>><?php echo $mayor['username']; ?></a></i></td>
		</tr>
		<tr>
			<td></td>
			<td></td>
		...
		<tr>
			...
			<td>Jedlo:</td>
			<td><i><?php echo $mayor['food']; ?></i></td>
		</tr>
		<tr>
			<td><img src="images/gold.png"></td>
			<td>Zlato:</td>
			<td><i><?php echo $mayor['gold']; ?></i></td>
		</tr>
	</table>
